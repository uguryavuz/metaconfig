...
(* `.  .'                                                                  *)
(*                                                                         *)
(* In a permutation of a set, each item in the set has a specific index    *) 
(* at which it appears.                                                    *)
(*                                                                         *)
(* `.  .'                                                                  *)
(***************************************************************************)
...
(* Every finite set of integers has a maximum element. *)
LEMMA MaxElement ==
...
(* `.  .'                                                                  *)
(*                                                                         *)
(* Every finite set of integers has a permutation that is sorted.          *)
(* (Here, in increasing order.)                                            *)
(*                                                                         *)
(* `.  .'                                                                  *)
(***************************************************************************)
THEOREM SortedPermutation ==
...
\* Last modified Tue Jul 02 21:18:06 UTC 2024 by uyavuz
